        ...
        */
        ...
        public static void Init()
        {
            ...
            else // else load the settings from settings.json
            {
                ...
                LoggerSetting = settings.RootElement.GetProperty("LoggerSetting").GetInt32();

                settings.Dispose(); // end the Parse

                Logger.Write("Loaded settings file. Autosave Value = " + Autosave + ", Display Value = " + Display + ", Folder Value = " + Folder + ", LoggerSetting Value = " + LoggerSetting + ".");
        ...
        public static void SaveSettings()
        {
            ...
            using (StreamWriter writer = new StreamWriter(SettingsFile))
            {
                ...
                writer.WriteLine("\"LoggerSetting\": " + LoggerSetting);
                writer.WriteLine("}");
                writer.Close();
            }
            Logger.Write("Saved Settings: Autosave Value = " + Autosave + ", Display Value = " + Display + ", Folder Value = " + Folder + ", LoggerSetting Value = " + LoggerSetting + ".");
        }
